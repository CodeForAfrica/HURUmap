...
CREATE TABLE public.heightforage (
...
COPY public.heightforage (geo_level, geo_code, "height for age", total, geo_version) FROM stdin;
...
ALTER TABLE ONLY public.heightforage
