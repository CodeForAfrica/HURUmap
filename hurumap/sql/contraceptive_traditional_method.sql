...
ALTER TABLE IF EXISTS ONLY public.contraceptive_traditional_method DROP CONSTRAINT IF EXISTS pk_contraceptive_traditional_method;
...
--
-- Name: contraceptive_traditional_method; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.contraceptive_traditional_method (
...
COPY public.contraceptive_traditional_method (geo_level, geo_code, contraceptive_traditional_method, total, geo_version) FROM stdin;
...
--
-- Name: contraceptive_traditional_method pk_contraceptive_traditional_method; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.contraceptive_traditional_method
    ADD CONSTRAINT pk_contraceptive_traditional_method PRIMARY KEY (geo_level, geo_code, geo_version, contraceptive_traditional_method);
