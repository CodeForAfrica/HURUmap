...
CREATE TABLE public.health_facilities_type (
...
COPY public.health_facilities_type (geo_level, geo_code, type, total) FROM stdin;
...
ALTER TABLE ONLY public.health_facilities_type
