...
# TODO move to HURUmap_land app tables since the the land data is unique to only hurumap_land
...
FieldTable(['last_national_election_persuade_others_to_vote_for_a_certain_candidate_or_party'],
           year=2016, dataset='Afrobarometer Survey',
           id='last_national_election_persuade_others_to_vote_for_a_certain_candidate_or_party')
FieldTable(
    ['how_effective_the_news_media_reveals_government_mistakes_and_corruption'],
    year=2016, dataset='Afrobarometer Survey',
    id='how_effective_the_news_media_reveals_government_mistakes_and_corruption')
