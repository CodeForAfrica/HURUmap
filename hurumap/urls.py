from census.views import DataView, ExampleView, HealthcheckView
...
from wazimap.urls import urlpatterns as wazimap_urlpatterns, \
    STANDARD_CACHE_TIME, EMBED_CACHE_TIME
...
urlpatterns = static(settings.STATIC_URL,
                  ...
                  url(
                      regex='^locate/$',
                      view=cache_page(STANDARD_CACHE_TIME)(LocateView.as_view(
                  ...
                  url(
                      ...
                      view=lambda r: HttpResponse(
                          "User-agent: *\nDisallow: /api/\n%s: /" % (
                              'Disallow' if getattr(settings, 'BLOCK_ROBOTS',
                                                    False) else 'Allow'),
