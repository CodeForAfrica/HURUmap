function makeEmbedFrame() {
    ...
    embedFrame.makeChartAbout = function() {
        ...
        embedFrame.elements.chartAbout = [
            ...
            '<ul>',
            '<li>This chart was generated by <a href="' + SITE_URL + '" target="_blank">' + SITE_NAME + '</a>, an app to help you find the story behind the data.</li>',
            '<li><a href="' + SITE_URL + '/profiles/' + embedFrame.params.geoID + '/" target="_blank">See more data from ' + embedFrame.data.geographyData['this'].full_name + '</a>',
            '</ul>'
        ].join('');
    }
