...
FieldTable(['contraceptive_use'], universe='Contraceptive_use', year='2014', dataset='KNBS Demographic and Health Survey')
FieldTable(
    ['contraceptive_modern_method'],
    universe='Contraceptive_use',
    year='2014', dataset='KNBS Demographic and Health Survey'
)
FieldTable(
...
FieldTable(['use of ipt'], universe='Maternal care indicators', year='2014',
           dataset='KNBS Demographic and Health Survey')
...
FieldTable(['treatment of children with fever'], year='2014',
           dataset='KNBS Demographic and Health Survey')
FieldTable(['protests'], year='2014', dataset='Annual Crimes Report')
FieldTable(['schoolfires'], year='2016', dataset='Annual Crimes Report')
FieldTable(['crimereport'], year='2015', dataset='Annual Crimes Report')
FieldTable(['typesofcrime'], year='2015', dataset='Annual Crimes Report')
...
FieldTable(['crop_production'], year='2014',
           dataset='Crop production and Livestock',
           description='Crop production and Livestock population for the year 2014 provided by the Ministry of Agriculture, Livestock and Fisheries.')
